...
require 'tracking_number/ups_mail_innovations'
...
module TrackingNumber
  TYPES = [UPS, UPSMailInnovations, FedExExpress, FedExSmartPost, FedExGround, FedExGround18, FedExGround96, USPS91, USPS20, USPS13, DHLExpress, DHLExpressAir, OnTrac]
